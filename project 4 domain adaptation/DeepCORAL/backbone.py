...
class ResNet34Fc(nn.Module):
    def __init__(self):
        ...
        model_resnet34 = models.resnet34(pretrained=PRETRAINED)
...
class ResNet101Fc(nn.Module):
    def __init__(self):
        ...
        model_resnet101 = models.resnet101(pretrained=PRETRAINED)
...
class ResNet152Fc(nn.Module):
    def __init__(self):
        ...
        model_resnet152 = models.resnet152(pretrained=PRETRAINED)
